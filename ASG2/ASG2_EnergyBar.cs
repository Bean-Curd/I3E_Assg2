...
public class ASG2_EnergyBar : MonoBehaviour
{
    ...
    public void Sprint(int amount)
    {
        ...
        {
            Player.instance.moveSpeed = 0.2f; //Increase movement speed if player can sprint
        ...
        {
            Player.instance.moveSpeed = 0.1f; //Reset movement speed if player is out of energy
        }
    }
